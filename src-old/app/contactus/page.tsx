  ...
  return (
    <main className="contactus_page_main">
            ...
            <div className="col-lg-12">
              <div className="adderess_form_mainbox">
                  ...
                  <div className="adderess_content_box">
                    ...
                    <div className="adderess_content_adderess">
                      ...
                      <div className="adderess_content_para">
                        Near Lupin Research Park, Gram: Lavale, <br /> Tal:
                        Mulshi, Pune 412 115
                      </div>
                    </div>
                  </div>
                  <div className="adderess_inquiry_number_box">
                    <div className="adderess_inquiry_number_left">
                      ...
                      <div className="adderess_inquiry_number_listing">
                        <a href="tel:+912061936300">+91-20-61936300/</a>
                        <a href="tel:+912061936464">6464/</a>
                        <a href="tel:+912061936419">6419</a>
                      </div>
                      <div className="adderess_inquiry_number_listing">
                        <a href="tel:+912028116300">+91-20-28116300/</a>
                        <a href="tel:+912028116464">6464/</a>
                        <a href="tel:+912028116419">6419</a>
                      </div>
                      <div className="adderess_inquiry_number_para">
                        Office timings : 8:30 AM to 4:30 PM <br />
                        [Monday to Saturday]
                      </div>
                    </div>
                    <div className="adderess_inquiry_number_right">
                      <div className="adderess_inquiry_number_right_listing">
                        <div className="adderess_inquiry_number_right_listing_left">
                          First year B.Tech:
                        </div>
                ...
                <div className="contact_form_mainbox">
                  <h2 className="heading innerpageheading">
      ...
      <div className="SITMap">
        <div className="container">
            <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d65217.31173431537!2d73.69784787751898!3d18.55539766807785!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bc3e3d28683b%3A0x64a3e9ef22f676a0!2sSymbiosis%20Institute%20of%20Technology%20%7C%20SIT%20Pune!5e1!3m2!1sen!2sin!4v1787050258566!5m2!1sen!2sin"
          width="100%"
          height="400"
          style={{ border: 0 }}
          allowFullScreen
          ...
          title="Symbiosis Institute of Technology Pune Location"
        />
        </div>
      </div>
    </main>
